...
- [What is a TIA, and is it serious?](https://www.stroke.org.uk/stroke/type/tia){:target="_blank" rel="noopener"} — Stroke Association (UK) explanation of transient ischaemic attack — a serious warning sign that requires urgent evaluation even when symptoms resolve quickly.
...
- [What is post-stroke fatigue?](https://www.stroke.org.uk/stroke/effects/physical/tiredness-and-fatigue){:target="_blank" rel="noopener"} — Stroke Association (UK) detailed explanation of post-stroke fatigue: why it happens, how it is different from ordinary tiredness, and what can help.
...
- [What is hemispatial neglect?](https://www.stroke.org.uk/stroke/effects/problems-noticing-things-on-one-side-spatial-neglect){:target="_blank" rel="noopener"} — Stroke Association (UK) explanation of hemispatial neglect (spatial neglect): what it is, how it presents, and how it is addressed in rehabilitation.
...
- [What is post-stroke depression, and does it improve?](https://www.stroke.org.uk/stroke/effects/emotional){:target="_blank" rel="noopener"} — Stroke Association (UK) overview of the emotional effects of stroke, including depression, anxiety, grief, and emotional changes — and what helps with each.
...
- [What is emotional lability after stroke?](https://www.stroke.org.uk/stroke/effects/emotional/changes-to-behaviour){:target="_blank" rel="noopener"} — Stroke Association (UK) explanation of changes to behaviour and emotional expression after stroke — including involuntary emotional responses, what causes them, and what helps.
...
- [What do carers of stroke survivors need to know?](https://www.stroke.org.uk/stroke/life-after/top-tips-family-and-friends){:target="_blank" rel="noopener"} — Stroke Association (UK) practical tips for family and friends supporting a stroke survivor: what to expect, how to help, and how to look after yourself.
...
- [What are my workplace rights after stroke?](https://www.stroke.org.uk/stroke/life-after/work){:target="_blank" rel="noopener"} — Stroke Association (UK) guide to returning to work after stroke: what to consider, what accommodations to ask for, and how to manage disclosure with an employer.
