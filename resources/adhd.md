...
- [What is happening in the ADHD brain?](https://add.org/adhd-brain/){:target="_blank" rel="noopener"} — Attention Deficit Disorder Association (ADDA) overview of the neuroscience of ADHD: how the prefrontal cortex, dopamine, and noradrenaline systems differ, and what this means for daily life.
- [What does neuroscience tell us about ADHD?](https://www.additudemag.com/neuroscience-of-adhd-brain/){:target="_blank" rel="noopener"} — ADDitude Magazine's accessible guide to the neuroscience of ADHD, covering brain structure, neurotransmitter systems, and what imaging studies reveal.
- [What causes ADHD and what do we know about its biology?](https://chadd.org/about-adhd/overview/){:target="_blank" rel="noopener"} — CHADD overview of ADHD symptoms, causes, and treatment, including the neurological basis and what the evidence says about heritability and brain differences.
...
- [What thinking skills are affected by ADHD, and why?](https://chadd.org/about-adhd/executive-function-skills/){:target="_blank" rel="noopener"} — CHADD's overview of executive function and ADHD: what executive functions are, how ADHD disrupts them, and what this means for daily life at work and home.
- [What is working memory, and why is it so affected by ADHD?](https://chadd.org/for-adults/overview/){:target="_blank" rel="noopener"} — CHADD adult overview explaining how working memory deficits — the inability to hold information in mind while using it — underlie many of the practical difficulties adults with ADHD experience.
- [Why do people with ADHD have such difficulty regulating their emotions?](https://add.org/emotional-dysregulation-adhd/){:target="_blank" rel="noopener"} — ADDA on emotional dysregulation in ADHD: why intense, rapidly shifting emotions are a core part of the condition, not a separate problem, and strategies for managing them.
- [What is ADHD like for adults on a day-to-day basis?](https://www.mayoclinic.org/diseases-conditions/adult-adhd/symptoms-causes/syc-20350878){:target="_blank" rel="noopener"} — Mayo Clinic explanation of how ADHD presents in adults, why it often goes unrecognised, and what conditions commonly co-occur.
- [What does the NHS say about ADHD in adults?](https://www.nhs.uk/conditions/adhd-adults/){:target="_blank" rel="noopener"} — NHS overview of adult ADHD including symptoms, causes, diagnosis, and treatment options.
...
- [What emotional difficulties are associated with ADHD in adults?](https://www.apa.org/monitor/2024/04/adhd-managing-emotion-dysregulation){:target="_blank" rel="noopener"} — American Psychological Association article on emotional dysregulation in adult ADHD: how psychologists understand and treat this often-overlooked dimension of the condition.
- [How does ADHD affect self-esteem, identity, and mental health?](https://chadd.org/for-adults/overview/){:target="_blank" rel="noopener"} — CHADD overview of the psychological impact of adult ADHD, including the emotional consequences of years of unrecognised impairment.
- [What do I do if I think I might have ADHD and live in BC?](https://www.heretohelp.bc.ca/q-and-a/im-an-adult-and-i-think-i-might-have-adhd){:target="_blank" rel="noopener"} — Here to Help BC guide to the steps for getting assessed in British Columbia, including where to start and what to expect.
...
- [How does ADHD affect marriages and long-term partnerships?](https://chadd.org/for-adults/marriage-and-partnerships/){:target="_blank" rel="noopener"} — CHADD resource on ADHD in partnerships: the common dynamics that develop, how to recognise them, and evidence-based approaches to rebalancing the relationship.
- [What can the non-ADHD partner do to cope and stay connected?](https://chadd.org/for-adults/relationships-social-skills/){:target="_blank" rel="noopener"} — CHADD resources on relationships and social skills for adults with ADHD, including guidance for both partners.
- [How can couples with ADHD build a stronger relationship?](https://chadd.org/attention-article/how-can-couples-with-adhd-keep-a-strong-relationship/){:target="_blank" rel="noopener"} — CHADD article on practical strategies for couples navigating ADHD together, grounded in research and clinical experience.
...
- [What does CBT for adult ADHD involve?](https://www.camh.ca/en/professionals/treating-conditions-and-disorders/adult-adhd/adult-adhd---treatment/adult-adhd---psychotherapy){:target="_blank" rel="noopener"} — CAMH overview of psychotherapy for adult ADHD, including how CBT is adapted for the specific cognitive and emotional challenges of the condition.
...
To access a psychiatrist in BC, ask your family doctor or a specialist for a referral. You can also call [HealthLink BC (8-1-1)](https://www.healthlinkbc.ca/){:target="_blank" rel="noopener"} for guidance on mental health services in your region.

**Other BC mental health resources**

- [Where can I find BC-specific mental health information and self-help resources?](https://www.heretohelp.bc.ca/){:target="_blank" rel="noopener"} — Here to Help BC provides mental health information, self-assessments, and connections to local services.
- [Is there a free CBT-based program for anxiety or low mood in BC?](https://bouncebackbc.ca/){:target="_blank" rel="noopener"} — BounceBack BC is a free, evidence-based CBT program run by CMHA BC for adults and youth 13+ managing low mood, anxiety, or stress. Delivered online or by phone with a coach.
- [How do I find mental health programs in my community?](https://bc.cmha.ca/){:target="_blank" rel="noopener"} — The Canadian Mental Health Association BC can help you find mental health programs and peer support across BC.
...
- [What does ADHD coaching involve, and is there evidence it helps?](https://caddac.ca/programs-events/adult-adhd-coaching-program/){:target="_blank" rel="noopener"} — CADDAC's six-week adult group coaching program: practical, structured, and led by trained coaches. An accessible and affordable starting point for building ADHD management skills.
- [What non-medication strategies are most effective for managing ADHD?](https://www.helpguide.org/mental-health/adhd/managing-adult-adhd){:target="_blank" rel="noopener"} — HelpGuide's evidence-based practical guide to managing ADHD in daily life, including structure, exercise, sleep, relationships, and work strategies.
- [What treatment options are available beyond medication?](https://www.mayoclinic.org/diseases-conditions/adult-adhd/diagnosis-treatment/drc-20350883){:target="_blank" rel="noopener"} — Mayo Clinic overview of ADHD treatment options including therapy, skills training, and lifestyle approaches alongside medication.
...
- [What is CADDAC, and how can it help me?](https://caddac.ca/){:target="_blank" rel="noopener"} — The Centre for ADHD Awareness, Canada is the national ADHD charity providing education, advocacy, support groups, and coaching programs for adults across Canada.
- [Where can I find clinical guidelines and patient guides for ADHD in Canada?](https://www.caddra.ca/){:target="_blank" rel="noopener"} — The Canadian ADHD Resource Alliance (CADDRA) is the national alliance of health professionals advancing ADHD care. Their public section includes patient guides and information on accessing assessment across Canadian provinces.

**International**

- [Where can I find comprehensive, science-based information about adult ADHD?](https://chadd.org/for-adults/){:target="_blank" rel="noopener"} — CHADD (Children and Adults with ADHD) is one of the most comprehensive ADHD resources available, with science-based information, online education, local support chapters, and a national helpline.
- [Where can I find practical, accessible ADHD information and strategies?](https://www.additudemag.com/){:target="_blank" rel="noopener"} — ADDitude Magazine is a widely read, clinician-reviewed resource covering all aspects of ADHD in adults, with articles, webinars, and expert Q&As.
- [Is there a peer-run ADHD organisation for adults?](https://add.org/){:target="_blank" rel="noopener"} — The Attention Deficit Disorder Association (ADDA) is an adult-focused ADHD organisation offering peer support groups, webinars, and practical resources.

---

If you are interested in a neuropsychological assessment to better understand attention or executive function difficulties, please [contact us](/contact/) or [submit a referral](/referral/).
