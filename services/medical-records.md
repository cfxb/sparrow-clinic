---
layout: page
title: How to request your medical records in British Columbia
description: "How to request copies of your own medical records in British Columbia — from BC hospitals, family physicians, and online portals like Health Gateway BC and Access My Health. Phone numbers for major BC hospitals included."
medical_records_schema: true
hero_title: Requesting medical records
hero_subtitle: How to get copies of your medical records in British Columbia
...
- [Health Gateway BC](https://www.healthgateway.gov.bc.ca){:target="_blank" rel="noopener"} — the BC government portal. Covers immunizations, prescriptions, lab results, imaging reports, hospital visits, COVID-19 results, and more, for residents enrolled with BC's Medical Services Plan.
- [Access My Health](https://www.accessmyhealth.ca){:target="_blank" rel="noopener"} — the Interior Health and Northern Health regional patient portal.
- [LifeLabs Patient Portal](https://www.lifelabs.com){:target="_blank" rel="noopener"} — for lab tests performed at LifeLabs locations in BC.
...
For records held by a family physician, specialist, or private clinic outside the hospital system, contact the office directly. Most clinics have a written records-request form and may charge a small administrative fee. Records are usually released within 30 days, in keeping with BC's [Personal Information Protection Act (PIPA)](https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/03063_01){:target="_blank" rel="noopener"} for private-sector providers, and BC's [Freedom of Information and Protection of Privacy Act (FIPPA)](https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96165_00){:target="_blank" rel="noopener"} for public-sector providers such as hospitals and health authorities.
...
See [services](/services/) for an outline of what an assessment involves, or [book an introductory consultation](/book/) to discuss whether assessment is right for you.
